...
namespace HealthPromotion.Migrations
{
    ...
    [Migration("20200510174535_ChangeScinceCategory")]
    partial class ChangeScinceCategory
    {
            ...
            modelBuilder.Entity("HealthPromotion.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 1,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 783, DateTimeKind.Local).AddTicks(7022),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 4,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8448),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8552),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8577),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 1,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8598),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8621),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 3,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8642),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 3,
                            DateTime = new DateTime(2020, 5, 10, 20, 45, 34, 784, DateTimeKind.Local).AddTicks(8662),
