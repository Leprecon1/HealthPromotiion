...
namespace HealthPromotion.Migrations
{
    ...
    [Migration("20200514200735_addTextToPost1")]
    partial class addTextToPost1
    {
            ...
            modelBuilder.Entity("HealthPromotion.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 1,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 707, DateTimeKind.Local).AddTicks(1423),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 4,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2627),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2736),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2763),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 1,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2784),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2808),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 3,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2829),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 3,
                            DateTime = new DateTime(2020, 5, 14, 23, 7, 34, 708, DateTimeKind.Local).AddTicks(2850),
