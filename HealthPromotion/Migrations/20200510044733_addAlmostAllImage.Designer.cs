...
namespace HealthPromotion.Migrations
{
    ...
    [Migration("20200510044733_addAlmostAllImage")]
    partial class addAlmostAllImage
    {
            ...
            modelBuilder.Entity("HealthPromotion.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 1,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 792, DateTimeKind.Local).AddTicks(7225),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 4,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(8782),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(8894),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(8923),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 1,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(8946),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 2,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(8972),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 3,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(8994),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CategoryId = 3,
                            DateTime = new DateTime(2020, 5, 10, 7, 47, 32, 793, DateTimeKind.Local).AddTicks(9017),
